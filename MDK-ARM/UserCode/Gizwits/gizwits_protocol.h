...
* @{
*/
#define PRODUCT_KEY "0c3e8d0682aa49fca7b5fff17b52d446"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "27a01a84975c47cb9a66e0e67f948b3e"
...
#define Door_LEN                           1
#define Electricity_BYTEOFFSET                    0
#define Electricity_BITOFFSET                     1
#define Electricity_LEN                           1
#define Fan_BYTEOFFSET                    0
#define Fan_BITOFFSET                     2
#define Fan_LEN                           3
#define AirWarn_BYTEOFFSET                    5
#define AirWarn_BITOFFSET                     0
#define AirWarn_LEN                           1
#define Fire_BYTEOFFSET                    5
#define Fire_BITOFFSET                     1
#define Fire_LEN                           1
